...
The project is currently in Stage 6. Modules 1–9 provide the desktop shell,
...
scoped local attachment storage. Chat attachments and Project sources can be
selected or dropped, previewed, removed, and recovered across failures without
exposing source paths to React; document parsing and RAG remain future work.
