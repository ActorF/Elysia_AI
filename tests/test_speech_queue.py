...
def test_binding_lease_freezes_selection_and_does_not_invent_trust() -> None:
    ...
    assert lease.synthesize("你好") == _result()
...
def test_binding_metadata_failure_cannot_kill_worker(
    ...
    """Contain a future lease's broken attestation property inside the job."""

    def binding_verified(lease: SpeechSynthesisBindingLease) -> bool:
